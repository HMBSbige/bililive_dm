...
namespace Bililive_dm.Properties {
    ...
    public class Resources {
        ...
        /// <summary>
        ///   查找类似 正则表达式过滤 符合正则表达式的弹幕将不会出现在任何地方直接丢弃 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 插件{0}遇到了不明错误: 日志已经保存在桌面, 请有空发给该插件作者 {1}, 联系方式 {2} 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 弹幕姬决定下版本开始停止支持Windows XP, 最低要求更改至 Win7 和 .NET 4.6.1,为保证你能在今后使用弹幕姬, 请安装最新的 .net framework . 的本地化字符串。
        /// </summary>
